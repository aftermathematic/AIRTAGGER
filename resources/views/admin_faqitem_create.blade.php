                            ...
                            <div class="col-md-9">
                                <div class="list-group-item list-group-item-action  lh-sm">
                                    ...
                                    <div class="col-10 mb-1 small">
                                        ...
                                        <form action="{{ route('faqItem.store') }}" method="post" class="form">
                                            @csrf
                                            ...
                                            <div class="form-outline mb-4">
                                                <textarea name="answer" class="form-control" rows="3"
                                                    placeholder="Answer" required="required"></textarea>
                                            </div>

                                            <div class="form-outline mb-4">
                                                <select class="form-select" name="faq_cat_id" required>
                                                    <option selected disabled value="">Select FAQ category</option>
                                                    @foreach($faqCats as $faqCat)
                                                    <option value="{{$faqCat->id}}">{{$faqCat->title}}</option>
                                                    @endforeach>
                                                </select>
                                            </div>
